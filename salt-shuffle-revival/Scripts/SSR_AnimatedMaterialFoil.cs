...
{
	[Serializable]
	public class SSR_AnimatedMaterialFoil : IScribedPart
	{
		...
		public SSR_AnimatedMaterialFoil()
			: base()
		{ }
		...
		public string GetOriginalTileColor()
			=> OriginalTileColor.IsNullOrEmpty()
			? ColorUtility.StripBackgroundFormatting(OriginalColorString)
			: OriginalTileColor
			;
